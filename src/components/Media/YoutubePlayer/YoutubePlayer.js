...
export function YoutubePlayer(props) {
  ...
  const focusSpeedRef = React.useRef(null);
              ...
              <div className="ds-flex">
                ...
                >
                  <Image
                    alt="Default Image"
                    id="image"
                    className="ds-filter ds-w-23px ds-h-23px"
                    src={rewindIcon}
                  />
                </button>
                {/* pause play controls */}
              ...
              <div className="ds-flex ds-ml-auto ds-flex-end">
                ...
                >
                  <Image
                    alt="Default Image"
                    id="image"
                    className="ds-filter ds-w-25px ds-h-25px"
